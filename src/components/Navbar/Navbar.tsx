    ...
    <nav className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
          <div className="max-w-5x2 mx-auto px-4 flex items-center justify-between h-20">
              ...
              <ul className="hidden md:flex space-x-12 font-extralight text-gray-700 ">
                ...
                <li><a href="#promocoes" className="hover:text-amber-600">Promoções</a></li>
          ...
          {open && (
              <div className="md:hidden bg-white border-t shadow-md">
                  <ul className="flex flex-col p-4 space-y-4 font-medium text-gray-700">
                    <li><Link to =""></Link></li>
                      <li><a href="#masculino" className="hover:text-blue-600">Masculino</a></li>
                      <li><a href="#feminino" className="hover:text-blue-600">Feminino</a></li>
                      <li><a href="#infantil" className="hover:text-blue-600">Infantil</a></li>
                      <li><a href="#promocoes" className="hover:text-amber-200">Promoções</a></li>
                  </ul>
